...
const Live = () => {
    return (
        <ScrollView>
            <View style={{ marginTop: height * 0.01, marginBottom: height * 0.02 }}>
                ...
                <View style={{ flex: 1, paddingHorizontal: width * 0.05 }}>
                    <FlatList
                        ...
                        renderItem={({ item, index }) => {
                            return (
                                <TouchableOpacity style={[bottomStyles.ScrollSm, { width: width * 0.9, marginBottom: height * 0.025, paddingLeft: width * 0.04, height: height * 0.15 }]}>
